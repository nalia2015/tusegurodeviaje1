<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pago-pendiente.aspx.cs" Inherits="TuSegurodeViaje.WebSite.pago_pendiente" %>
...
<html>
	<head runat=server>
		<title>Pago Pendiente | Tu Seguro de Viaje</title>
		<meta charset="utf-8" />
...
<%--        <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" />
        ...
        <!-- Header -->
                    <header id="headern" class="alt">
                        <h1><a href="index.html" class="logotu">&nbsp;</a></h1>
                        <nav id="nav">
                            <ul>
                                <li class="special22">
                ...
                <section class="box sub">
                    ...
                    <div class="row">
                      <div class="12u 12u(mobilep)">
                       ...
                       <div class="mensajep">Su pago esta pendiente, en breve nos pondremos en contacto con usted.</div>
                       <span class='tituloenviar'><a href="pago-pendiente.aspx?op=iraimprimir"><i class='fa fa-file-pdf-o'></i> Ver Voucher</a></span><br> 
                      </div>
                    </div>
  				</section>
  			</div>
